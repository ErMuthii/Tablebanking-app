    ...
    >
      <Card className="overflow-hidden p-0 shadow-lg border-0 rounded-2xl max-w-3xl w-full">
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <form className="p-8 flex flex-col justify-center bg-white rounded-r-2xl">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                <h1 className="text-2xl font-bold text-[#1F5A3D]">
                  Welcome back
                </h1>
                <p className="text-gray-600 text-balance mt-1">
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button
                  variant="outline"
                  type="button"
                  className="w-full border-[#1F5A3D] text-[#1F5A3D] hover:bg-green-50"
                >
                ...
                <Button
                  variant="outline"
                  type="button"
                  className="w-full border-[#D4A664] text-[#D4A664] hover:bg-yellow-50"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
      ...
      <div className="text-muted-foreground *:[a]:hover:text-[#1F5A3D] text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4 mt-4">
