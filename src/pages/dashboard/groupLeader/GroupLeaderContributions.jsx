...
<div className="w-8 h-8 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-full flex items-center justify-center text-white text-sm font-semibold">
  ...
  const myTotalContributions = myContributions.reduce((sum, contrib) => sum + contrib.amount, 0);
  const groupTotalContributions = groupContributions.reduce((sum, contrib) => sum + contrib.amount, 0);
  const uniqueContributors = new Set(groupContributions.map(c => c.contributor)).size;
...
<div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl mb-4">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Track your own contributions and monitor your group's financial activity
          </p>
        </div>
  ...
  <Card className="bg-gradient-to-r from-emerald-500 to-teal-600 border-0 shadow-xl">
    <CardContent className="p-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-emerald-100 text-sm font-medium">My Total</p>
  ...
  <Card className="bg-gradient-to-r from-emerald-500 to-teal-600 border-0 shadow-xl">
    <CardContent className="p-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-emerald-100 text-sm font-medium">Group Total</p>
          <p className="text-2xl font-bold text-white">
  ...
  <Card className="bg-gradient-to-r from-emerald-500 to-teal-600 border-0 shadow-xl">
    <CardContent className="p-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-emerald-100 text-sm font-medium">Contributors</p>
          <p className="text-2xl font-bold text-white">
            {uniqueContributors}
          </p>
        </div>
            ...
            <div className="p-6 border-b border-slate-200">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  ...
                  <p className="text-slate-600 mt-1">Your personal contribution history</p>
                </div>
                <Button 
              ...
              <DataTable
                ...
                noDataComponent={
                  <div className="py-12 text-center">
                    ...
                    <p className="text-slate-500 text-sm">Start by making your first contribution</p>
                  </div>
                }
                customStyles={{
                  headCells: {
...
<h2 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
  ...
  Group Contributions
                  ...
                  <p className="text-slate-600 mt-1">All contributions from group members</p>
                </div>
              ...
              <DataTable
                ...
                noDataComponent={
                  <div className="py-12 text-center">
                    ...
                    <p className="text-slate-600 text-lg">No group contributions found</p>
                    <p className="text-slate-500 text-sm">Group contributions will appear here once members start contributing</p>
                  </div>
                }
                customStyles={{
                  headCells: {
